...
const SEED = [
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Builds components; technical consultant" },
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Supports vendor evaluation; manages implementation" },
      { who: "Empty Cup Digital", what: "HubSpot components + integration of new platform" },
      { who: "ClickUp", what: "Builds v1 ClickUp paid media workflows" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Builds business-system components" },
      { who: "AI & Automation", what: "Leads AI workflow implementation" },
      { who: "ClickUp", what: "ClickUp integration and workflow build" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Builds HubSpot + ClickUp enforcement logic" },
      { who: "Empty Cup Digital", what: "HubSpot form access configuration" },
      { who: "ClickUp", what: "ClickUp workflow warnings" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Architects HubSpot + ClickUp structure; writes integration specs" },
      ...
      { who: "ClickUp", what: "Workflow + integrations" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Builds ClickUp order workflow" },
      ...
      { who: "ClickUp", what: "RevOps-scoped build work" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Builds ClickUp workflow and HubSpot sync" },
      ...
      { who: "ClickUp", what: "Rebate review workflow build" },
    ],
  ...
  },
  {
    ...
    roles: [
      ...
      { who: "Business Systems", what: "Manages requirements handoff to Product" },
      { who: "AI & Automation", what: "Owns and executes in-app UI changes to Concierge placement and accessibility" },
    ],
