...
const SEED = [
  {
    ...
    roles: [
      { who: "Marketing Services", what: "Defines requirements; validates model accuracy", effort: "S" },
      { who: "Business Systems", what: "Builds components; technical consultant", effort: "L" },
      { who: "Data", what: "Leads build vs. buy; builds pipelines and Omni reporting", effort: "XL" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Marketing Services", what: "Defines requirements; leads vendor evaluation and selection", effort: "M" },
      { who: "Business Systems", what: "Supports vendor evaluation; manages implementation", effort: "L" },
      { who: "HubSpot", what: "HubSpot components + integration of new platform", effort: "M" },
      { who: "ClickUp", what: "Builds v1 ClickUp paid media workflows", effort: "M" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Marketing Services", what: "Jenn + Christina lead requirements and own operations; Kennedy adds SME input as she onboards", effort: "S" },
      { who: "Business Systems", what: "Builds business-system components", effort: "M" },
      { who: "AI & Automation", what: "Leads AI workflow implementation", effort: "L" },
      { who: "ClickUp", what: "ClickUp integration and workflow build", effort: "M" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Marketing Services", what: "Jenn leads initial eligibility matrix; Johanna approves and owns rules ongoing", effort: "S" },
      { who: "Business Systems", what: "Builds HubSpot + ClickUp enforcement logic", effort: "S" },
      { who: "HubSpot", what: "HubSpot form access configuration", effort: "S" },
      { who: "ClickUp", what: "ClickUp workflow warnings", effort: "XS" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Supplies", what: "Defines fields, workflow steps, comms content; validates each phase", effort: "S" },
      { who: "Business Systems", what: "Architects HubSpot + ClickUp structure; writes integration specs", effort: "L" },
      { who: "Engineering", what: "Supports stretch: automated enable-ordering in Moxie Admin", effort: "S" },
      { who: "HubSpot", what: "HubSpot object/pipeline build", effort: "M" },
      { who: "ClickUp", what: "Workflow + integrations", effort: "M" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Supplies", what: "Defines order workflows, vendor requirements, fulfillment tracking; validates phases", effort: "S" },
      { who: "Business Systems", what: "Builds ClickUp order workflow", effort: "M" },
      { who: "Engineering", what: "Builds API integrations with vendor ordering portals", effort: "L" },
      { who: "Data", what: "Vendor data pipeline into Snowflake; Omni fulfillment reporting (stretch)", effort: "M" },
      { who: "ClickUp", what: "RevOps-scoped build work", effort: "M" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Supplies", what: "Defines rebate structures, threshold logic, workflow requirements; validates reporting", effort: "S" },
      { who: "Business Systems", what: "Builds ClickUp workflow and HubSpot sync", effort: "M" },
      { who: "Data", what: "Shopify pipeline; rebate data model; Omni dashboard", effort: "L" },
      { who: "HubSpot", what: "HubSpot spend sync build and field mapping", effort: "M" },
      { who: "ClickUp", what: "Rebate review workflow build", effort: "M" },
    ],
  ...
  },
  {
    ...
    roles: [
      { who: "Practice Success", what: "Defines visibility and accessibility requirements; leads vendor vetting if applicable", effort: "S" },
      { who: "Business Systems", what: "Manages requirements handoff to Product", effort: "S" },
      { who: "AI & Automation", what: "Owns and executes in-app UI changes to Concierge placement and accessibility", effort: "M" },
    ],
